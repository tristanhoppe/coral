...
(function($) {
    ...
    var methods = {
        ...
        initIndent: function() {
            ...
            var expandercollapsed = $this.find('.treegrid-expander-collapsed');
            var depth = $this.treegrid('getDepth');
            var posIndents=0;//0--place Indents Before Expander 1-- place Indents After Expander
            if (posIndents==0){
                console.log(expandercollapsed.length);
            }
